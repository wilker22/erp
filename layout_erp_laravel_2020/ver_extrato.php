...
<div class="rows">	
                ...
                <div class="caixa">
					...
					<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Extrato do produto </span>
                    <div>
                        ...
                        <div class="px-2 pt-2">
							  ...
							  <div class="rows">
                                        ...
                                        <div class="col-10 mb-2">	
                                                <label class="text-label d-block text-branco">Selecione um produto </label>
                                        ...
                                        <div class="col-2 mt-1 pt-1">
                                                <input type="submit" value="Ver extrato" class="btn btn-roxo text-uppercase width-100">
                                        </div>
                                </div>
                                </div>
                        </div>
