...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de ordem de produção </span>
						<div>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                <tr>
									...
									<th align="center" width="160">Ação</th>
									<th align="center" width="160">Ação</th>
								</tr>
                            </thead>
                            <tbody>                                      
                             <tr>
									...
									<td align="center"><span class="status recusado">Finalizado</span></td> 											
									<td align="center">
										<a href="" class="d-inline-block btn btn-outline-verde status digitacao"> Detalhes</a>	
									</td>									
									<td align="center">
										<a href="" class="d-inline-block btn btn-outline-verde status digitacao"> Detalhes</a>	
									</td>
							...
							<tr>
									...
									<td align="center">
										<a href="index.php?link=35" class="d-inline-block btn btn-outline-verde status recusado"> Acompanhar</a>	
									</td>
							</tr>
