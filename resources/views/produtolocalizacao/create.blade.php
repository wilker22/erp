...
<div class="col-9 central mb-3">
    <div class="rows">
                    ...
                    <div class="caixa">
                        ...
                        <form name="frm_produtolocalizacao" action="{{ route('produtolocalizacao.store') }}" method="POST">
                            @csrf
                            <div class="px-2 pt-2">
                        ...
                        <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                                <thead>
                                        <tr>
                                           ...
                                           <th align="center" width="20%">Estoque</th>
                                ...
                                <tbody>
                                    @foreach ($lista as $pl)
                                        <tr>
                                            <td align="left">{{ $pl->produto }}</td>
                                            <td align="left">{{ $pl->localizacao }}</td>
                                            <td align="center">{{ $pl->estoque }}</td>
